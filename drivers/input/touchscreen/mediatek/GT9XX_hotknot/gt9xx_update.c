...
s32 gup_load_fx_system(void)
{
	...
	{
		GTP_ERROR("[load_fx_system]firmware's length is invalid1.");
		goto load_fx_exit;
	}
...
s32 gup_load_hotknot_system(void)
{
	...
	if(length > 32*1024 || length < 4*1024 )
	{
		GTP_ERROR("[load_hotknot_system]firmware's length is invalid2.");
...
s32 gup_recovery_main_system(void)
{
	...
	{
		GTP_ERROR("[recovery_main_system]firmware's length is invalid3.");
