...
#if ((defined(GTP_AUTO_UPDATE) && defined(GTP_HEADER_FW_UPDATE)) || defined(GTP_COMPATIBLE_MODE))
#include "tpd_firmware_gt9xx.h"
#endif
...
#if (defined(GTP_AUTO_UPDATE) && (!defined(GTP_HEADER_FW_UPDATE) || defined(GTP_AUTO_UPDATE_CFG)))
...
{
#if (defined(GTP_AUTO_UPDATE) && defined(GTP_HEADER_FW_UPDATE))
...
#if (FLASHLESS_FLASH_WORKROUND && defined(GTP_ESD_PROTECT))
		gtp_esd_switch(i2c_client_point, SWITCH_ON);
#endif
